...
# Background
export BACKGROUND_HEIGHT=26
export BACKGROUND_COLOR=0xBB2E3750
export BACKGROUND_BORDER_WIDTH=1
export BACKGROUND_BORDER_COLOR="$ORANGE"
export BACKGROUND_CORNER_RADIUS=8
export BACKGROUND_MARGIN=8
export BACKGROUND_PADDING=0
